...
DEEPGATE_SRC="/home/c_1006/LSV/DeepGate2/src"       # 設置 DeepGate2 源代碼的路徑
EXP_BASE="/home/c_1006/LSV/DeepGate2/exp/prob"      # 設置實驗基礎目錄路徑
LOG_BASE="/home/c_1006/LSV/PA2/results/assignment2" # 設置日誌保存的基礎目錄
EPOCHS=5    # 設置訓練的輪數為 5
DIM=64      # 設置隱層維度為 64
